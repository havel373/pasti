                            ...
                            <div class="mb-0">
                                ...
                                <div class="row gx-12 mb-5">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" id="nama" name="nama" class="form-control form-control-solid" placeholder="Nama" />
                                        </div>
                                        <div class="mb-5">
                                            <input type="text" id="nim" name="nim" class="form-control form-control-solid" placeholder="Nim" />
                                        </div>
                                        <div class="mb-5">
                                            <input type="text" id="email" name="email" class="form-control form-control-solid" placeholder="Email" />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-5">
